    	...
    	<main id="main" class="dFlex">
    		...
    		<div id="contents" class="reply">
				...
				<form name="replyFrm" action="/replyProc"
					...
					<table id="replyTbl">
						<tbody id="replyTblBody">
							<tr>
								<td class="req">작성자</td>
								<td>${result.uName }
									[<span class="ori_Txt">원본 작성자 : <b>${read.uName }</b></span> ]
							...
							<tr>
								...
								<td>
									<input type="text" name="subject" value=""
										size="50" id="subject">								
									(<span class="ori_Txt">원본 제목 : <b>${read.subject }</b></span> )
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									cols="89" readonly>${read.content }</textarea>
					...
					<input type="hidden" name="num" value="${read.num }" id="num">				
					<input type="hidden" name="uId" value="${read.uId }">	
